...
# 1. REGISTER THE ROUTING MATRIX WITH THE STANDARD PATH SEPARATOR
# This matches the native folder structure Streamlit's switch utility expects
pages_matrix = [
...
# 2. POSITION SIDEBAR DIRECTORY
# Keeping the position parameter set to "sidebar" ensures parents have navigation access,
# while completely omitting app.py from the array blocks the ghost link from printing!
current_page = st.navigation(pages_matrix, position="sidebar")

# 3. RUN CONTROLLER ENGINES
current_page.run()
